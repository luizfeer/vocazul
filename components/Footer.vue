    ...
    <footer class="my-6 py-10 font-gordita w-screen" style="background: #F5F5F7">
        <div class="container px-0 pr-2">
            <div class="flex justify-between py-5">
                    <div class="logo">
                        <img id="image0" width="188" height="35" src="~assets/img/logo-blue.svg">
                    </div>

                    <div class="login border-solid border border-blue-5 text-blue-5 rounded-full py-2 px-6">Login</div>
